...
params = list(
  ...
  ratio_rad = 3, # ratio between apical and basal radius
  cyl_length = 15, # cylinder length
  gamma = 0.15, # contractility    0.15 (hexagonal) 0.04 (soft)
  lambda = 0.04,  # adhesion  0.04 (heaxgonal) 0 (soft)
...
```{r}
fileName <- "results/single/results_simulation_25_03_27.RData"
...
```{r}
N_SIM = 5 # number of simulations with different seeds
parameters_list = list(
  n_steps = 3, # simulation steps
  n_cells = 10, # number of cells
  n_layers = 5, # numbers of layers (min 3)
  apical_rad = 4/(2*pi), # apical radius
  ratio_rad = 3, # ratio between apical and basal radius 
  cyl_length = 15, # cylinder length
...
start_time <- Sys.time()
log_file <- "results/parallel/simulation_log.txt"
...
```{r}
fileName <- "results/parallel/results_simulation_25_03_27_"
N_SIM = 3
