...
```{r}
PATH_ANALYSIS = "tubular_simulations_source/source__simulation_analysis.R"
source(PATH_ANALYSIS)

# Average energies relaxdation over time
enerhist_average <- energy_analisis_averages(par_results, it = par_parameters$n_steps, lay = par_parameters$n_layers, n = par_parameters$n_cells)
knitr::kable(enerhist_average[1:10,], format="html") 
```
