...
Am <- (2*pi*par_parameters$apical_rad*(par_parameters$cyl_length))/par_parameters$n_cells
edgearsim<-funaux2simDOUBLE(resord,n=par_parameters$n_cells,ps=N_SIM, A0=Am)
stationarylewis(edgearsim[[1]][1:(par_parameters$n_cells*N_SIM),c(1,2)]) #DOESNT WORK
...
# Scutoids table
#points <- par_results$results[[,1]]$points_evolution
