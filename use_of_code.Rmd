...
```{r}
fileName <- "results/parallel/results_simulation_25_01_31_"
N_SIM = 10 
...
pts_info = save_tessellation_layers(points, n = par_parameters$n_cells, RadiusA = par_parameters$apical_rad, Ratio = par_parameters$ratio_rad,
                                     ...
                                     filename = paste0("saved_tessellations/saved_tessellation_iteration_",saveIteration,".csv"))
```
