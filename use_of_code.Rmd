...
#apical area
stationarylewis(edgear[[1]][1:parameters$n_cells,c(1,2,3)])
#basal area
stationarylewis(edgear[[2]][1:parameters$n_cells,c(1,2,3)])
...
par_results <- foreach(i=c(1,2,3,4,5), .combine = rbind, .packages = "deldir") %dopar% {
...
for(i in 1:N_SIM){
  filename <- paste0("results/parallel/results_simulation_25_01_17_",i,".RData")
...
stationarylewis(edgearsim[[1]][1:(par_parameters$n_cells*N_SIM),c(1,2,3)])  
# Average number of neighbors in the basal area
stationarylewis(edgearsim[[2]][1:(par_parameters$n_cells*N_SIM),c(1,2,3)])  
