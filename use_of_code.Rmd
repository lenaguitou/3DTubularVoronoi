...
```{r}
saveFrame <- 2 # last frame is parameters$n_cells
...
pointsinit <- filter(result_alg[[1]], Frame == saveFrame)
pts_info = save_tessellation_layers(pointsinit, n = parameters$n_cells, RadiusA =parameters$apical_rad, Ratio = parameters$ratio_rad,
