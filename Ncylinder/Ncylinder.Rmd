...
We import the necessary libraries from our repository (stored in the file "N-cylinder/MetropolisAlgorithm.R").
```{r message=FALSE, warning=FALSE, include=FALSE}
PATH_PROJECT = "C:/Users/lenaa/Downloads/VoronoiMetropolis-main/VoronoiMetropolis-main/Ncylinder/"
setwd(PATH_PROJECT)
knitr::opts_knit$set(root.dir = PATH_PROJECT)
PATH_MODEL = "C:/Users/lenaa/Downloads/VoronoiMetropolis-main/VoronoiMetropolis-main/Source/Ncylinder/source_MetropolisAlgorithm.R"
source(PATH_MODEL)
```

Now we set the necessary parameters. If we forget to set the value of some parameter, it will take the default values (set in "MetropolisAlgorithm.R" file)
```{r}
params = list(
  seed = 42, # 
  ...
  # elastic K = 1 cause adimentional
  beta = 100, #
  s0=1 # 
  )
```

The function that performs Metropolis Algorithm is called "metropolisad" (the ad suffix refers to the adimensionality of the algorithm). Now we do a call of the function with the parameters desired.
```{r}
...
```{r,include=FALSE}
PATH_ANALYSIS = "C:/Users/lenaa/Downloads/VoronoiMetropolis-main/VoronoiMetropolis-main/Source/Analysis/source_analysis.R"
...
```{r,include=FALSE}
PATH_SIMANALYSIS = "C:/Users/lenaa/Downloads/VoronoiMetropolis-main/VoronoiMetropolis-main/Source/Analysis/source_simulation_analysis.R"
