...
We import the necessary libraries from our repository (stored in the file "N-cylinder/MetropolisAlgorithm.R"). Change path project to the folder where 
the git project has been cloned. Use getwd() if needed. 
```{r message=FALSE, warning=FALSE, include=FALSE}
PATH_PROJECT = "∼/3DTubularVoronoi/"
setwd(PATH_PROJECT)
knitr::opts_knit$set(root.dir = PATH_PROJECT)
PATH_MODEL = "∼/3DTubularVoronoi/Source/source_MetropolisAlgorithm.R"
source(PATH_MODEL)
```
