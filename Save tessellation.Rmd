...
```{r}
PATH_PROJECT = "/home/ada/lguitou/Downloads/3DTubularVoronoi/"
setwd(PATH_PROJECT)
...
```{r}
PATH_MODEL = "/home/ada/lguitou/Downloads/3DTubularVoronoi/Source/source_MetropolisAlgorithm.R"
source(PATH_MODEL)
library("iterators")
library("parallel")
params = list(
...
dir.create(file.path(PATH_PROJECT,"saved_tessellations/"))
pointsinit <- filter(result_alg[[1]], Frame ==1)
pointsend <- filter(result_alg[[1]], Frame==steps)
